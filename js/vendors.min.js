...
let pageSlider = new Swiper('.page', {
	...
	pagination: {
		...
		type: 'bullets',
		clickable: 'true',
		bulletClass: 'page__bulet',
		bulletActiveClass: 'page__bulet_active',
	},
	scrollbar: {
		el: '.page__scroll',
...
let footerBlock = document.querySelector('.footer-screen__content')
...
function paralaxHuman() {
	...
	for (let index = 0; index < human.length; index++) {
		...
		element.style.transform = "translate(" + (positionX / forHuman) + "%, " + (positionY / forHuman) + "%)";
		forHuman -= 1
		speed += 0.3;
...
// screenImg.forEach((item) => {
// 	item.addEventListener('mousemove', function (e) {
// 		const screenImgWidth = item.offsetWidth;
// 		const screenImgHeight = item.offsetHeight;
// 		const coordX = e.pageX - screenImgWidth / 2;
// 		const coordY = e.pageY - screenImgHeight / 2;
// 		coordXProcent = coordX / screenImgWidth * 100;
// 		coordYProcent = coordY / screenImgHeight * 100;
...
// 	const screenImgWidth = screenImg.offsetWidth;
// 	const screenImgHeight = screenImg.offsetHeight;
// 	const coordX = e.pageX - screenImgWidth / 2;
// 	const coordY = e.pageY - screenImgHeight / 2;
// 	coordXProcent = coordX / screenImgWidth * 100;
// 	coordYProcent = coordY / screenImgHeight * 100;
...
const dItems = document.querySelectorAll('.four-screen__cifres');
if (dItems.length > 0) {
	function dItemsAnimate(item, start, end, duration) {
		...
		function run() {
			...
			function tt() {
				item.innerHTML = digi(value).replace(' ', ',') + '+';
	...
	// setTimeout(initDigiItems, 10000)
	initDigiItems();
}

dItems.forEach((item, index) => {
	item.style.cssText = "opacity: 0; transition: 0.3s"
